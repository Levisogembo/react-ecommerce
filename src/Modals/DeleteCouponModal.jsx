...
const DeleteCouponModal = ({ coupon , onClose, onConfirm }) => {
    //
    console.log(coupon);
        ...
        <div className='fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4'>
            <div className='bg-gray-800 border border-gray-700 rounded-xl w-full max-w-sm overflow-hidden'>
                ...
                <div className='p-6 flex flex-col items-center text-center gap-3'>
                    ...
                    {/* text */}
                    <div>
                        <p className='text-sm font-medium text-white mb-1'>Delete coupon</p>
                    ...
                    <div className='bg-gray-900 border border-gray-700 rounded-lg px-3 py-2 w-full flex items-center gap-3'>
                        <div className='text-left'>
                            <p className='text-xs font-medium text-emerald-100'>Coupon Name: {coupon.code}</p>
                            <p className='text-xs text-gray-500'>Discount Type: {coupon.discountType}</p>
                            <p className='text-xs text-gray-500'>Discount Amount: {coupon.discountValue}</p>
                        </div>
                    </div>
                </div>
